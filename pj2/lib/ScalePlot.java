 ...
 * The weak sequential fraction is
 * <I>G</I>&nbsp;=&nbsp;(<I>c</I>&nbsp;+&nbsp;<I>dN</I>)/<I>T</I>(<I>N</I>,1).
 * The total sequential fraction is <I>F</I>&nbsp;+&nbsp;<I>G</I>.
 *
	...
	public static void main
		...
		problemSizeList.forEachItemDo (new Action<String>()
			...
			public void run (String label)
				{
				System.out.println();
				System.out.printf ("Label\tN       \tK\tT\tSpdup\tEffic\tF\tG\tF+G%n");
				Key key = new Key (label, 0);
				...
				for (int K = 1; K <= Kmax; ++ K)
					...
					if (timeMap.contains (key))
						...
						double F = seqfr (a, b, N_K, T_1);
						double G = seqfr (c, d, N_K, T_1);
						System.out.printf
							("\t%.2e\t%d\t%d\t%.3f\t%.3f\t%.2e\t%.2e\t%.2e%n",
							 N_K, K, T_K,
