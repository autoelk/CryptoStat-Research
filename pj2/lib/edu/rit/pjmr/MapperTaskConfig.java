 ...
 * @version 27-May-2016
 */
public class MapperTaskConfig<I,C,K,V extends Vbl>
...
// Exported data members.
	...
	AList<SourceConfig<I,C,K,V>> sourceConfigList =
		new AList<SourceConfig<I,C,K,V>>();
...
// Exported operations.
	...
	public SourceConfig<I,C,K,V> source
		...
		SourceConfig<I,C,K,V> sc =
			new SourceConfig<I,C,K,V> (this, source);
	 ...
	 */
	public <T extends Customizer<K,V>>
	MapperTaskConfig<I,C,K,V> customizer
	 ...
	 */
	public MapperTaskConfig<I,C,K,V> threads
		(int threads)
		{
	 ...
	 */
	public MapperTaskConfig<I,C,K,V> schedule
		(Schedule schedule)
		{
	 ...
	 */
	public MapperTaskConfig<I,C,K,V> chunk
		(int chunk)
		{
	 ...
	 */
	public MapperTaskConfig<I,C,K,V> jvmFlags
		(String... jvmFlags)
		{
	 ...
	 * @return  This mapper task config object.
	 */
	public MapperTaskConfig<I,C,K,V> debug
		(Debug... debug)
		{
	...
	public void readIn
		...
		sourceConfigList = (AList<SourceConfig<I,C,K,V>>)
			in.readReference();
		in.clearCache();
...
// Hidden operations.
	...
	void validate
		...
		for (int i = 0; i < sourceCount; ++ i)
			{
			SourceConfig<I,C,K,V> sourceConfig = sourceConfigList.get (i);
