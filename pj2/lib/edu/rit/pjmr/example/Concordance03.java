//******************************************************************************
//
// File:    Concordance03.java
// Package: edu.rit.pjmr.example
// Unit:    Class edu.rit.pjmr.example.Concordance03
//
...
/**
 * Class Concordance03 is the main program for a {@linkplain edu.rit.pjmr PJMR}
 * map-reduce job that computes a concordance of one or more text files.
 * <P>
 * Usage: <TT>java pj2 edu.rit.pjmr.example.Concordance03 <I>file</I>
 * [<I>file</I> ...]</TT>
 * <P>
 ...
 * {@linkplain TextFileSource}, {@linkplain Mapper}, and {@linkplain
 * Customizer}.
 *
 * @author  Alan Kaminsky
 * @version 27-May-2016
 */
public class Concordance03
	...
	private static void usage()
		{
		System.err.println ("Usage: java pj2 edu.rit.pjmr.example.Concordance03 <file> [<file> ...]");
		terminate (1);
		}
