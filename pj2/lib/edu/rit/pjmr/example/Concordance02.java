//******************************************************************************
//
// File:    Concordance02.java
// Package: edu.rit.pjmr.example
// Unit:    Class edu.rit.pjmr.example.Concordance02
//
...
/**
 * Class Concordance02 is the main program for a {@linkplain edu.rit.pjmr PJMR}
 * map-reduce job that computes a concordance of one or more text files.
 * <P>
 * Usage: <TT>java pj2 edu.rit.pjmr.example.Concordance02 <I>file</I>
 * [<I>file</I> ...]</TT>
 * <P>
...
public class Concordance02
	...
	private static void usage()
		{
		System.err.println ("Usage: java pj2 edu.rit.pjmr.example.Concordance02 <file> [<file> ...]");
		terminate (1);
		}
