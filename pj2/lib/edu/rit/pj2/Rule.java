...
// Exported operations.
	 ...
	 * <P>
	 * <I>Note:</I> If <TT>copies</TT> is {@link Job#DEFAULT_WORKERS
	 * DEFAULT_WORKERS}, one copy of the given task will be added to this rule's
	 * task group.
	 *
	 * @param  <T>        Task data type.
	 * @param  copies     Number of copies (&ge; 1), or
	 *                    <TT>DEFAULT_WORKERS</TT>.
	 * @param  taskClass  Task subclass.
	 *
	 * @return  Task specification for the given task.
	 *
	...
	public <T extends Task> TaskSpec task
		(int copies,
		 Class<T> taskClass)
		{
		if (copies == Job.DEFAULT_WORKERS) copies = 1;
		if (copies < 1)
