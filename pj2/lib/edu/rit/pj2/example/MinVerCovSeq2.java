//******************************************************************************
//
// File:    MinVerCovSeq2.java
// Package: edu.rit.pj2.example
// Unit:    Class edu.rit.pj2.example.MinVerCovSeq2
//
 ...
 * of a graph via exhaustive search. The program constructs a {@linkplain
 ...
 * <P>
 * Class {@linkplain MinVerCovSeq} constructs a new object on every loop
 * iteration. Class MinVerCovSeq2 reuses the same object on every loop
 * iteration.
 * <P>
 * For further information about constructor expressions, see class {@linkplain
 * edu.rit.util.Instance edu.rit.util.Instance}.
 * <P>
 * Usage: <TT>java pj2 edu.rit.pj2.example.MinVerCovSeq2 "<I>ctor</I>"</TT>
 * <BR><TT><I>ctor</I></TT> = GraphSpec constructor expression
 *
 * @author  Alan Kaminsky
 * @version 26-Apr-2018
 */
public class MinVerCovSeq2
	extends Task
	{
	...
	private static void error
		(String msg)
		{
		System.err.printf ("MinVerCovSeq2: %s%n", msg);
		terminate (1);
		}
	...
	private static void usage()
		{
		System.err.println ("Usage: java pj2 edu.rit.pj2.example.MinVerCovSeq2 \"<ctor>\"");
