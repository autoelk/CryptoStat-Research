//******************************************************************************
//
// File:    MandelbrotSmp2.java
// Package: edu.rit.pj2.example
// Unit:    Class edu.rit.pj2.example.MandelbrotSmp2
//
 ...
 * Mandelbrot Set.
 * <P>
 * Usage: <TT>java pj2 edu.rit.pj2.example.MandelbrotSmp2 <I>width</I> <I>height</I>
 ...
 * file is written concurrently with the computation (overlapped computation and
 * I/O). The program measures the computation's running time, including the time
 * to write the image file.
 * <P>
 * Here is an example command and the resulting image:
 * <P>
 * <TT>$ java pj2 edu.rit.pj2.example.MandelbrotSmp2 400 400 -0.75 0 150 1000 0.4 ms400a.png</TT>
 * <P>
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java pj2 edu.rit.pj2.example.MandelbrotSmp2 <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <gamma> <filename>");
