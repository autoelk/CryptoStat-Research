...
import edu.rit.util.RandomGraph;
 ...
 * <P>
 * The program's running time is proportional to
 * <I>N</I>&sdot;2<SUP><I>V</I></SUP>.
 * <P>
 * Usage: <TT>java pj2 [workers=<I>K</I>] edu.rit.pj2.example.MinVerCovDist
 * <I>N</I> <I>V</I> <I>E</I> <I>seed</I></TT>
...
public class MinVerCovDist
	...
	private static class WorkerTask
		...
		public void main
			...
			// Set up to generate random graphs.
			graph = new AMGraph64();
			prng = new Random (seed + taskRank());
			generator = new RandomGraph (V, E, prng);
				...
				public void run (int trial) throws Exception
					...
					parallelFor (0L, full) .exec (new LongLoop()
						...
						public void run (long elems)
							...
							if (graph.isVertexCover (candidate))
