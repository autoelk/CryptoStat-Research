//******************************************************************************
//
// File:    MandelbrotSmp3.java
// Package: edu.rit.pj2.example
// Unit:    Class edu.rit.pj2.example.MandelbrotSmp3
//
 ...
 * Mandelbrot Set.
 * <P>
 * Usage: <TT>java pj2 edu.rit.pj2.example.MandelbrotSmp3 <I>width</I> <I>height</I>
 ...
 * <P>
 * The computation is performed in parallel in multiple processors. The image
 * file is written sequentially after the computation is finished. The program
 * measures the computation's running time, including the time to write the
 * image file. The program also measures the computation's problem size, namely,
 * the number of executions of the inner loop body.
 * <P>
 * Here is an example command and the resulting image:
 * <P>
 * <TT>$ java pj2 edu.rit.pj2.example.MandelbrotSmp3 400 400 -0.75 0 150 1000 0.4 ms400a.png</TT>
 * <P>
...
// Program shared variables.
	...
	LongVbl totaliter = new LongVbl.Sum();
...
// Main program.
	...
	public void main
		...
		parallelFor (0, height - 1)
			...
			LongVbl thrTotaliter;
			
			public void start()
				{
				pixelData = new ColorArray (width);
				thrTotaliter = threadLocal (totaliter);
				}
...
// Hidden operations.
	...
	private static void usage()
		{
		System.err.println ("Usage: java pj2 edu.rit.pj2.example.MandelbrotSmp3 <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <gamma> <filename>");
