...
// Exported operations.
	...
	/**
	 * Reduce the given short integer into this shared variable. This shared
	...
	public void reduce
		...
		throw new UnsupportedOperationException
			("reduce() not defined in base class ShortVbl; use a subclass");
		}
	...
	public void reduce
		(Vbl vbl)
		{
		reduce (((ShortVbl)vbl).shortValue());
		}
...
// Exported subclasses.
	...
	public static class Min
		...
		public void reduce
			(short x)
			{
			this.item = (short) Math.min (this.item, x);
			}
		}
	...
	public static class Max
		...
		public void reduce
			(short x)
			{
			this.item = (short) Math.max (this.item, x);
			}
		}
