...
// Unit:    Class edu.rit.pj2.vbl.StringVbl
//
...
/**
 * Class StringVbl provides a string reduction variable shared by multiple
 * threads executing a {@linkplain edu.rit.pj2.ParallelStatement
 * ParallelStatement}. A StringVbl is also a {@linkplain Tuple}.
 * <P>
 * Class StringVbl supports the <I>parallel reduction</I> pattern. Each thread
...
// Exported constructors.
	...
	/**
	 * Construct a new shared string variable. The item's initial value is null.
	 */
	public StringVbl()
		{
		}
	...
	/**
	 * Construct a new shared string variable with the given initial value.
	 *
...
// Exported operations.
	...
	/**
	 * Returns the string value of this shared variable.
	 * <P>
	 * The base class <TT>stringValue()</TT> method returns the {@link #item
	 * item} field. A subclass may override the <TT>stringValue()</TT> method to
	...
	public void set
		(Vbl vbl)
		{
		this.item = ((StringVbl)vbl).item;
		}

	/**
	 * Reduce the given string into this shared variable. This shared variable's
	...
	public void reduce
		...
		throw new UnsupportedOperationException
			("reduce() not defined in base class StringVbl; use a subclass");
		}
	...
	public void reduce
		(Vbl vbl)
		{
		reduce (((StringVbl)vbl).stringValue());
		}
