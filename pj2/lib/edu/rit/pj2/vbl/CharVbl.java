 ...
 * <UL>
 * <LI>Minimum -- Class {@linkplain CharVbl.Min}
 * <LI>Maximum -- Class {@linkplain CharVbl.Max}
 * </UL>
 *
...
// Exported operations.
	...
	/**
	 * Reduce the given character into this shared variable. This shared
	...
	public void reduce
		...
		throw new UnsupportedOperationException
			("reduce() not defined in base class CharVbl; use a subclass");
		}
...
// Exported subclasses.
	...
	/**
	 * Class CharVbl.Min provides a character reduction variable, with minimum
	...
	public static class Min
		...
		{
		/**
		 * Construct a new shared character variable. The item's initial value
		 * is 0.
		 */
		public Min()
			{
		...
		/**
		 * Construct a new shared character variable with the given initial
		 * value.
		 *
		 * @param  value  Initial value.
		 */
		...
		public void reduce
			(char x)
			{
			this.item = (char) Math.min (this.item, x);
			}
		}

	/**
	 * Class CharVbl.Max provides a character reduction variable, with maximum
	 * as the reduction operation.
	 *
	 * @author  Alan Kaminsky
	 * @version 11-Oct-2016
	...
	public static class Max
		...
		public void reduce
			(char x)
			{
			this.item = (char) Math.max (this.item, x);
			}
		}
