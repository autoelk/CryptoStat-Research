...
// Exported operations.
	 ...
	 * <P>
	 * The base class <TT>byteValue()</TT> method returns the {@link #item item}
	...
	/**
	 * Reduce the given byte into this shared variable. This shared variable's
	...
	public void reduce
		...
		throw new UnsupportedOperationException
			("reduce() not defined in base class ByteVbl; use a subclass");
		}
...
// Exported subclasses.
	...
	public static class Sum
		...
		/**
		 * Reduce the given byte into this shared variable. This shared
	...
	public static class Min
		...
		public void reduce
			(byte x)
			{
			this.item = (byte) Math.min (this.item, x);
			}
		}
	...
	public static class Max
		...
		public void reduce
			(byte x)
			{
			this.item = (byte) Math.max (this.item, x);
			}
		}
