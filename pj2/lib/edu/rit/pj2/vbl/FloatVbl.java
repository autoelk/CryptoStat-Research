...
// Exported operations.
	 ...
	 * field. A subclass may override the <TT>floatValue()</TT> method to
	...
	/**
	 * Reduce the given float into this shared variable. This shared variable's
	...
	public void reduce
		...
		throw new UnsupportedOperationException
			("reduce() not defined in base class FloatVbl; use a subclass");
		}
	...
	public void reduce
		(Vbl vbl)
		{
		reduce (((FloatVbl)vbl).floatValue());
		}
...
// Exported subclasses.
	...
	public static class Sum
		...
		/**
		 * Reduce the given float into this shared variable. This shared
	 ...
	 * computation. Call the {@link #floatValue()} method to get the mean of
	...
	public static class Mean
		...
		/**
		 * Reduce the given float into this shared variable. The mean of the
		 * values accumulated into this shared variable is updated to include
		 * <TT>x</TT>.
		 *
		 * @param  x  Float.
