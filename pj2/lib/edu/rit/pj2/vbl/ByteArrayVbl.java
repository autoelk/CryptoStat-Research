//******************************************************************************
//
// File:    ByteArrayVbl.java
// Package: edu.rit.pj2.vbl
// Unit:    Class edu.rit.pj2.vbl.ByteArrayVbl
//
...
/**
 * Class ByteArrayVbl provides a byte array reduction variable shared by
 * multiple threads executing a {@linkplain edu.rit.pj2.ParallelStatement
 * ParallelStatement}. A ByteArrayVbl is also a {@linkplain Tuple}.
 * <P>
 * Class ByteArrayVbl supports the <I>parallel reduction</I> pattern. Each
 ...
 * <UL>
 * <LI>Sum &mdash; Class {@linkplain ByteArrayVbl.Sum}
 * <LI>Minimum &mdash; Class {@linkplain ByteArrayVbl.Min}
 * <LI>Maximum &mdash; Class {@linkplain ByteArrayVbl.Max}
 * <LI>Bitwise Boolean and &mdash; Class {@linkplain ByteArrayVbl.And}
 * <LI>Bitwise Boolean or &mdash; Class {@linkplain ByteArrayVbl.Or}
 * <LI>Bitwise Boolean exclusive-or &mdash; Class {@linkplain ByteArrayVbl.Xor}
 * </UL>
 *
 * @author  Alan Kaminsky
 * @version 03-Feb-2017
 */
public class ByteArrayVbl
	extends Tuple
	implements Vbl
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new shared byte array variable. The {@link #item item}
	...
	/**
	 * Construct a new shared byte array variable with the given length. The
...
// Exported operations.
	...
	public Object clone()
		{
		ByteArrayVbl vbl = (ByteArrayVbl) super.clone();
		vbl.set (this);
		return vbl;
		}
	...
	public void set
		(Vbl vbl)
		{
		this.item = (byte[]) ((ByteArrayVbl)vbl).item.clone();
		}

	/**
	 * Reduce the given byte into the given array element of this shared
	 * variable.
	 * <P>
	...
	public void reduce
		...
		throw new UnsupportedOperationException
			("reduce() not defined in base class ByteArrayVbl; use a subclass");
		}

	/**
	 * Reduce the given byte array into this shared variable.
	 * <P>
	...
	public void readIn
		...
		throws IOException
		{
		item = in.readByteArray();
		}

// Exported subclasses.

	/**
	 * Class ByteArrayVbl.Sum provides a byte array reduction variable, with
	...
	public static class Sum
		...
		/**
		 * Construct a new shared byte array variable with the given length.
	...
	/**
	 * Class ByteArrayVbl.Min provides a byte array reduction variable, with
	...
	public static class Min
		...
		public void reduce
			(int i,
			 byte x)
			{
			item[i] = (byte) Math.min (item[i], x);
			}
		}

	/**
	 * Class ByteArrayVbl.Max provides a byte array reduction variable, with
	...
	public static class Max
		...
		public void reduce
			(int i,
			 byte x)
			{
			item[i] = (byte) Math.max (item[i], x);
			}
		}

	/**
	 * Class ByteArrayVbl.And provides a byte array reduction variable, with
	...
	/**
	 * Class ByteArrayVbl.Or provides a byte array reduction variable, with
	...
	/**
	 * Class ByteArrayVbl.Xor provides a byte array reduction variable, with
