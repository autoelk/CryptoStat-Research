...
// Exported operations.
	 ...
	 * item} field. A subclass may override the <TT>booleanValue()</TT> method
	...
	/**
	 * Reduce the given Boolean into this shared variable. This shared
	...
	public void reduce
		...
		throw new UnsupportedOperationException
			("reduce() not defined in base class BooleanVbl; use a subclass");
		}
	...
	public void reduce
		(Vbl vbl)
		{
		reduce (((BooleanVbl)vbl).booleanValue());
		}
...
// Exported subclasses.
	...
	public static class And
		 ...
		 * Reduce the given Boolean into this shared variable. This shared
		 * variable's {@link #item item} field and the argument <TT>x</TT> are
		 * combined together using the Boolean and operation, and the result is
	...
	public static class Or
		 ...
		 * Reduce the given Boolean into this shared variable. This shared
		 * variable's {@link #item item} field and the argument <TT>x</TT> are
		 * combined together using the Boolean or operation, and the result is
		 * stored in the {@link #item item} field.
		 *
		 * @param  x  Boolean.
		 */
	...
	public static class Xor
		 ...
		 * Reduce the given Boolean into this shared variable. This shared
		 * variable's {@link #item item} field and the argument <TT>x</TT> are
		 * combined together using the Boolean exclusive-or operation, and the
