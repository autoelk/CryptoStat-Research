//******************************************************************************
//
// File:    LongArrayVbl.java
// Package: edu.rit.pj2.vbl
// Unit:    Class edu.rit.pj2.vbl.LongArrayVbl
//
...
/**
 * Class LongArrayVbl provides a long integer array reduction variable shared by
 * multiple threads executing a {@linkplain edu.rit.pj2.ParallelStatement
 * ParallelStatement}. A LongArrayVbl is also a {@linkplain Tuple}.
 * <P>
 * Class LongArrayVbl supports the <I>parallel reduction</I> pattern. Each
 ...
 * <UL>
 * <LI>Sum &mdash; Class {@linkplain LongArrayVbl.Sum}
 * <LI>Minimum &mdash; Class {@linkplain LongArrayVbl.Min}
 * <LI>Maximum &mdash; Class {@linkplain LongArrayVbl.Max}
 * <LI>Bitwise Boolean and &mdash; Class {@linkplain LongArrayVbl.And}
 * <LI>Bitwise Boolean or &mdash; Class {@linkplain LongArrayVbl.Or}
 * <LI>Bitwise Boolean exclusive-or &mdash; Class {@linkplain LongArrayVbl.Xor}
 * </UL>
 *
 * @author  Alan Kaminsky
 * @version 03-Feb-2017
 */
public class LongArrayVbl
	extends Tuple
	implements Vbl
	{
...
// Exported constructors.
	...
	/**
	 * Construct a new shared long integer array variable. The {@link #item
	...
	/**
	 * Construct a new shared long integer array variable with the given length.
...
// Exported operations.
	...
	public Object clone()
		{
		LongArrayVbl vbl = (LongArrayVbl) super.clone();
		vbl.set (this);
		return vbl;
		}
	...
	public void set
		(Vbl vbl)
		{
		this.item = (long[]) ((LongArrayVbl)vbl).item.clone();
		}

	/**
	 * Reduce the given long integer into the given array element of this shared
	 * variable.
	 * <P>
	...
	public void reduce
		...
		throw new UnsupportedOperationException
			("reduce() not defined in base class LongArrayVbl; use a subclass");
		}

	/**
	 * Reduce the given long integer array into this shared variable.
	 * <P>
	 ...
	 * are not updated.
	 *
	 * @param  array  Long integer array.
	 */
	public void reduce
		(long[] array)
		{
	...
	public void readIn
		...
		throws IOException
		{
		item = in.readLongArray();
		}

// Exported subclasses.

	/**
	 * Class LongArrayVbl.Sum provides a long integer array reduction variable,
	 * with addition as the reduction operation.
	 *
	 * @author  Alan Kaminsky
	 * @version 03-Feb-2017
	 */
	public static class Sum
		extends LongArrayVbl
		{
		/**
		 * Construct a new shared long integer array variable. The {@link #item
		 * item} field is a zero-length array.
		...
		/**
		 * Construct a new shared long integer array variable with the given
		...
		/**
		 * Reduce the given long integer into the given array element of this
		 * shared variable.
		 * <P>
		 * The {@link #item item} field's element at index <TT>i</TT> and the
	...
	/**
	 * Class LongArrayVbl.Min provides a long integer array reduction variable,
	...
	/**
	 * Class LongArrayVbl.Max provides a long integer array reduction variable,
	...
	/**
	 * Class LongArrayVbl.And provides a long integer array reduction variable,
	 * with bitwise Boolean and as the reduction operation.
	 *
	 * @author  Alan Kaminsky
	 * @version 31-Jan-2017
	 */
	...
	/**
	 * Class LongArrayVbl.Or provides a long integer array reduction variable,
	...
	/**
	 * Class LongArrayVbl.Xor provides a long integer array reduction variable,
	 * with bitwise Boolean exclusive-or as the reduction operation.
	 *
	 * @author  Alan Kaminsky
	 * @version 03-Feb-2017
	 */
