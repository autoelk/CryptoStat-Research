...
// Exported operations.
	...
	/**
	 * Reduce the given histogram into this shared variable. This shared
	 * variable's {@link #hist hist} field and the <TT>hist</TT> argument are
	 * combined together using this shared variable's reduction operation, and
	 * the result is stored in the {@link #hist hist} field.
	 * <P>
	 * Class HistogramVbl's <TT>reduce()</TT> method adds the given histogram
	 * into this variable's histogram.
	 *
