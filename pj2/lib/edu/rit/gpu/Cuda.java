...
// Exported constants.
	...
	// Values for the cuCtxSetLimit() and cuCtxGetLimit() limit parameter.
    public static final int J_CU_LIMIT_STACK_SIZE                       = 0x00;
    public static final int J_CU_LIMIT_PRINTF_FIFO_SIZE                 = 0x01;
    public static final int J_CU_LIMIT_MALLOC_HEAP_SIZE                 = 0x02;
    public static final int J_CU_LIMIT_DEV_RUNTIME_SYNC_DEPTH           = 0x03;
    public static final int J_CU_LIMIT_DEV_RUNTIME_PENDING_LAUNCH_COUNT = 0x04;
...
// Exported operations.
	...
	/**
	 * Set a resource limit for the given CUDA context.
	 *
	 * @param  ctx    CUDA context.
	 * @param  limit  Resource limit to set.
	 * @param  value  Size of limit.
	 *
	 * @exception  CudaException
	 *     (unchecked exception) Thrown if a CUDA error occurred.
	 */
	public static native void cuCtxSetLimit
		(long ctx,
		 int limit,
		 long value);

	/**
	 * Get a resource limit for the given CUDA context.
	 *
	 * @param  ctx    CUDA context.
	 * @param  limit  Resource limit to get.
	 *
	 ...
	 *     (unchecked exception) Thrown if a CUDA error occurred.
	 */
	public static native long cuCtxGetLimit
		(long ctx,
		 int limit);
