...
// Hidden data members.
	...
	AList<String> finalMsgs = new AList<String>();
...
//	/**
//	 * Add the given message to be printed when this GPU variable is finalized.
//	 *
//	 * @param  msg  Message.
//	 */
//	public void addFinalMsg
//		(String msg)
//		{
//		finalMsgs.addLast (msg);
//		}
...
//			{
//			System.out.printf ("GpuVbl.finalize()%n");
//			System.out.printf ("  class = %s%n", getClass().getName());
//			System.out.printf ("  gpu = %s%n", gpu);
//			System.out.printf ("  bytesize = %d%n", bytesize);
//			System.out.printf ("  dynamic = %b%n", dynamic);
//			System.out.printf ("  dptr = %d%n", dptr);
//			finalMsgs.forEachItemDo (new Action<String>()
//				{
