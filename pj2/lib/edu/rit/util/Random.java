...
// Exported operations.
	...
	/**
	 * Return an element chosen uniformly at random from the given Boolean
	 * array.
	 *
	 ...
	 *     (unchecked exception) Thrown if <TT>array</TT> is zero length.
	 */
	...
	/**
	 * Return an element chosen uniformly at random from the given byte array.
	 *
	...
	/**
	 * Return an element chosen uniformly at random from the given character
	 * array.
	 *
	...
	/**
	 * Return an element chosen uniformly at random from the given short integer
	 * array.
	 *
	...
	/**
	 * Return an element chosen uniformly at random from the given integer
	 * array.
	 *
	...
	/**
	 * Return an element chosen uniformly at random from the given long integer
	 * array.
	 *
	...
	/**
	 * Return an element chosen uniformly at random from the given float array.
	 *
	...
	/**
	 * Return an element chosen uniformly at random from the given double array.
	 *
	...
	/**
	 * Return an element chosen uniformly at random from the given object array.
	 *
