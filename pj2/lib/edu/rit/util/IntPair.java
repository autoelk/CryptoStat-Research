...
// Unit:    Class edu.rit.util.IntPair
//
...
/**
 * Class IntPair encapsulates a pair consisting of a key and its associated
 * value of type <TT>int</TT>. The key must be an object suitable for use in a
 ...
 * changed.
 * <P>
 * Class IntPair is streamable. For object streaming to work properly, the key
...
// Exported operations.
	 ...
	 * using {@link OutStream#writeReference(Object) writeReference()}. The
	 * value is written using {@link OutStream#writeInt(int) writeInt()}.
	 *
	 ...
	 * {@link InStream#readReference() readReference()}. The value is read using
	 * {@link InStream#readInt() readInt()}.
	 *
	 * @param  in  In stream.
	 *
	 * @exception  IOException
