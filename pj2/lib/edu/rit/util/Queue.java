...
// Exported constructors.
	...
	/**
	 * Construct a new queue that is a shallow copy of the given queue. The new
	 * queue's entries contain the same items in the same order as the given
	 * queue. Time: <I>O</I>(<I>n</I>).
	 *
...
// Exported operations.
	...
	/**
	 * Set this queue to a shallow copy of the given queue. Afterwards, this
	 * queue contains the same items in the same order as the given queue. Time:
	 * <I>O</I>(<I>n</I>).
	 *
	 * @param  queue  Queue to copy.
	 */
	...
	/**
	 * Write this object's fields to the given out stream. The queue items are
	...
	public void writeOut
		...
		for (int i = 0; i < size; ++ i)
			{
			out.writeReference (item[from]);
			from = incr (from, max);
			}
		}

	/**
	 * Read this object's fields from the given in stream. The queue items are
