...
// Exported operations.
	...
	public void solve
		...
		if (D < 0)
			...
			double TWO_SQRT_Q = 2*Math.sqrt(-Q);
			x1 = TWO_SQRT_Q*Math.cos(theta/3) - a_over_3;
			x2 = TWO_SQRT_Q*Math.cos((theta+TWO_PI)/3) - a_over_3;
			x3 = TWO_SQRT_Q*Math.cos((theta+FOUR_PI)/3) - a_over_3;
			sortRoots();
			}
		else if (D > 0.0)
			{
