...
#undef edu_rit_gpu_Cuda_J_CU_LIMIT_STACK_SIZE
#define edu_rit_gpu_Cuda_J_CU_LIMIT_STACK_SIZE 0L
#undef edu_rit_gpu_Cuda_J_CU_LIMIT_PRINTF_FIFO_SIZE
#define edu_rit_gpu_Cuda_J_CU_LIMIT_PRINTF_FIFO_SIZE 1L
#undef edu_rit_gpu_Cuda_J_CU_LIMIT_MALLOC_HEAP_SIZE
#define edu_rit_gpu_Cuda_J_CU_LIMIT_MALLOC_HEAP_SIZE 2L
#undef edu_rit_gpu_Cuda_J_CU_LIMIT_DEV_RUNTIME_SYNC_DEPTH
#define edu_rit_gpu_Cuda_J_CU_LIMIT_DEV_RUNTIME_SYNC_DEPTH 3L
#undef edu_rit_gpu_Cuda_J_CU_LIMIT_DEV_RUNTIME_PENDING_LAUNCH_COUNT
#define edu_rit_gpu_Cuda_J_CU_LIMIT_DEV_RUNTIME_PENDING_LAUNCH_COUNT 4L
/*
