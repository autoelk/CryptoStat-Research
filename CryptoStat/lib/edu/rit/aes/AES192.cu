...
/**
 * The CUDA implementation of the AES-192 block cipher. The <I>A</I> input is
 * the plaintext (128 bits). The <I>B</I> input is the key (192 bits). The
