...
/**
 * The CUDA implementation of the AES-256 block cipher. The <I>A</I> input is
 * the plaintext (128 bits). The <I>B</I> input is the key (256 bits). The
