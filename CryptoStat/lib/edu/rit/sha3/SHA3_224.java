...
// Unit:    Class edu.rit.sha3.SHA3_224
//
...
/**
 * Class SHA3_224 implements the SHA3-224 hash function with a 64-byte (512-bit)
 * message. The SHA3-224 cryptographic function's input <I>A</I> is the first
 * portion of the message (256 bits); input <I>B</I> is the second portion of
 * the message (256 bits); output <I>C</I> is the digest (224 bits).
 *
 * @author  Aziel Shaw
 * @version 21-Mar-2019
 */
public class SHA3_224 extends SHA3Base {

    /**
     * Returns the constructor
     * @return The constructor for SHA3 224
     */
    @Override
    public String constructor() {
        return "edu.rit.sha3.SHA3_224()";
    }
    ...
    protected String moduleName() {
        return "edu/rit/sha3/SHA3_224.ptx";
    }
    ...
    protected void instanciateRate(BigInt A, BigInt B) {
        ...
        A13 = 0x0000000000000000L; // PADDING 9
        A23 = 0x8000000000000000L; // PADDING 10
        // Capacity
        A33 = 0x0000000000000000L; // c1
        A43 = 0x0000000000000000L; // c2
        A04 = 0x0000000000000000L; // c3
        A14 = 0x0000000000000000L; // c4
        A24 = 0x0000000000000000L; // c5
        A34 = 0x0000000000000000L; // c6
        A44 = 0x0000000000000000L; // c7
    }
    ...
    protected void recordDigest(BigInt dig, 
        ...
        dig.value[6] = (int)(tmp >> 32);
        dig.value[5] = (int)(tmp);
        tmp = Long.reverseBytes(b);
        dig.value[4] = (int)(tmp >> 32);
        dig.value[3] = (int)(tmp);
        tmp = Long.reverseBytes(c);
        dig.value[2] = (int)(tmp >> 32);
        dig.value[1] = (int)(tmp);
        tmp = Long.reverseBytes(d);
        dig.value[0] = (int)(tmp >> 32);
    }
