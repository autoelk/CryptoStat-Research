...
// Unit:    Class edu.rit.sha3.SHA3_384
//
...
/**
 * Class SHA3_384 implements the SHA3-384 hash function with a 64-byte (512-bit)
 * message. The SHA3-384 cryptographic function's input <I>A</I> is the first
 * portion of the message (256 bits); input <I>B</I> is the second portion of
 * the message (256 bits); output <I>C</I> is the digest (384 bits).
 *
 * @author  Aziel Shaw
 * @version 21-Mar-2019
 */
public class SHA3_384 extends SHA3Base {

    /**
     * Returns the constructor
     * @return The constructor for SHA3 384
     */
    @Override
    public String constructor() {
        return "edu.rit.sha3.SHA3_384()";
    }
    ...
    protected String moduleName() {
        return "edu/rit/sha3/SHA3_384.ptx";
    }
    ...
    protected void instanciateRate(BigInt A, BigInt B) {
        ...
        A22 = 0x8000000000000000L; // PADDING 5
        // Capacity
        A32 = 0x0000000000000000L; //  c1
        A42 = 0x0000000000000000L; //  c2
        A03 = 0x0000000000000000L; //  c3
        A13 = 0x0000000000000000L; //  c4
        A23 = 0x0000000000000000L; //  c5
        A33 = 0x0000000000000000L; //  c6
        A43 = 0x0000000000000000L; //  c7
        A04 = 0x0000000000000000L; //  c8
        A14 = 0x0000000000000000L; //  c9
        A24 = 0x0000000000000000L; // c10
        A34 = 0x0000000000000000L; // c11
        A44 = 0x0000000000000000L; // c12
    }
