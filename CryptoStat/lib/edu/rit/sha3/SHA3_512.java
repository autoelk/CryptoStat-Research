...
// Unit:    Class edu.rit.sha3.SHA3_512
//
...
/**
 * Class SHA3_512 implements the SHA3-512 hash function with a 64-byte (512-bit)
 * message. The SHA3-512 cryptographic function's input <I>A</I> is the first
 * portion of the message (256 bits); input <I>B</I> is the second portion of
 * the message (256 bits); output <I>C</I> is the digest (512 bits).
 *
 * @author  Aziel Shaw
 * @version 21-Mar-2019
 */
public class SHA3_512 extends SHA3Base {

    /**
     * Returns the constructor
     * @return The constructor for SHA3 512
     */
    @Override
    public String constructor() {
        return "edu.rit.sha3.SHA3_512()";
    }
    ...
    public String description() {
        return "SHA3-512s hash function";
    }
    ...
    protected String moduleName() {
        return "edu/rit/sha3/SHA3_512.ptx";
    }
    ...
    protected void instanciateRate(BigInt A, BigInt B) {
        ...
        A21 = Barr[3]; // B4
        // Padding
        A31 = 0x8000000000000006L; // PADDING 1
        // Capacity
        A41 = 0x0000000000000000L; //  c1
        A02 = 0x0000000000000000L; //  c2
        A12 = 0x0000000000000000L; //  c3
        A22 = 0x0000000000000000L; //  c4
        A32 = 0x0000000000000000L; //  c5
        A42 = 0x0000000000000000L; //  c6
        A03 = 0x0000000000000000L; //  c7
        A13 = 0x0000000000000000L; //  c8
        A23 = 0x0000000000000000L; //  c9
        A33 = 0x0000000000000000L; // c10
        A43 = 0x0000000000000000L; // c11
        A04 = 0x0000000000000000L; // c12
        A14 = 0x0000000000000000L; // c14
        A24 = 0x0000000000000000L; // c15
        A34 = 0x0000000000000000L; // c16
        A44 = 0x0000000000000000L; // c17
    }
