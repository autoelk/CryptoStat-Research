...
/**
 * The CUDA implementation of the SHA-512 hash function. The <I>A</I> input is
 * the first part of the message (512 bits). The <I>B</I> input is the second
 * part of the message (320 bits). The <I>C</I> output is the digest (512 bits).
 *
...
#define IV_0 0x6a09e667f3bcc908L
#define IV_1 0xbb67ae8584caa73bL
#define IV_2 0x3c6ef372fe94f82bL
#define IV_3 0xa54ff53a5f1d36f1L
#define IV_4 0x510e527fade682d1L
#define IV_5 0x9b05688c2b3e6c1fL
#define IV_6 0x1f83d9abfb41bd6bL
#define IV_7 0x5be0cd19137e2179L
