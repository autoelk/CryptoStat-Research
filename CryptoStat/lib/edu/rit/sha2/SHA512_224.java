//******************************************************************************
//
// File:    SHA512_224.java
// Package: edu.rit.sha2
// Unit:    Class edu.rit.sha2.SHA512_224
//
...
/**
 * Class SHA512_224 implements the SHA-512/224 hash function with a 104-byte
 * (832-bit) message. The SHA512_224 cryptographic function's input <I>A</I> is
 * the first portion of the message (512 bits); input <I>B</I> is the second
 * portion of the message (320 bits); output <I>C</I> is the digest (224 bits).
 * <P>
 * Class SHA512_224 computes the digest of one 1024-bit block consisting of the
...
// Exported constructors.
	...
	/**
	 * Construct a new SHA-512/224 cryptographic function.
	 */
	public SHA512_224()
		{
		super
...
// Exported operations.
	...
	public String constructor()
		{
		return "edu.rit.sha2.SHA512_224()";
		}
	...
	public String description()
		{
		return "SHA-512/224 hash function";
		}
...
// Hidden operations.
	...
	protected String moduleName()
		{
		return "edu/rit/sha2/SHA512_224.ptx";
		}
