...
//
// File:    SHA512_256.cu
// Unit:    SHA-512/256 CUDA functions
//
...
/**
 * The CUDA implementation of the SHA-512/256 hash function. The <I>A</I> input
 * is the first part of the message (512 bits). The <I>B</I> input is the second
 * part of the message (320 bits). The <I>C</I> output is the digest (256 bits).
 *
...
#define IV_0 0x22312194FC2BF72C
#define IV_1 0x9F555FA3C84C64C2
#define IV_2 0x2393B86B6F53B151
#define IV_3 0x963877195940EABD
#define IV_4 0x96283EE2A88EFFE3
#define IV_5 0xBE5E1E2553863992
#define IV_6 0x2B0199FC2C85B8AA
#define IV_7 0x0EB72DDC81C52CA2
