...
/**
 * The CUDA implementation of the SHA-256 hash function. The <I>A</I> input is
 * the first part of the message (256 bits). The <I>B</I> input is the second
 * part of the message (160 bits). The <I>C</I> output is the digest (256 bits).
 *
