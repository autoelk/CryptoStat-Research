...
// Unit:    Class edu.rit.crst.Scattered
//
...
/**
 * Class Scattered provides an object that generates a series of output bit
 * groups for a cryptographic {@linkplain Function Function}. Each bit group
 * consists of scattered (non-adjacent) randomly chosen bit positions. The bit
...
// Exported operations.
	...
	public String constructor()
		{
		return String.format ("Scattered(%d,%d)", size, seed);
		}
	...
	public String description()
		{
		return String.format ("%d-bit groups, scattered bits", size);
		}
	...
	public String bitGroupDescription
		(int i)
		{
		return scatteredBitsDescription (i);
		}
...
// Hidden operations.
	...
	protected void generate()
		...
		RandomSubset rs = new RandomSubset (prng, func.C_bitSize(), true);
