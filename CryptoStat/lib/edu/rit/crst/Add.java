...
/**
 * Class Add provides an object that generates input values for a cryptographic
 * {@linkplain Function Function}.
 * <P>
 * An instance of class Add is layered on top of another input generator. The
 * latter is specified as an argument to the Add constructor, in the form of a
 * constructor expression. The Add constructor uses the constructor expression
 ...
 * <P>
 * Class Add invokes the underlying input generator to generate a series of
 * cryptographic function input values. Class Add then adds to each input
 * value a constant value specified as a constructor argument. This constant
 * serves as an "initial value" for the input sequence.
 *
...
// Exported constructors.
	...
	/**
	 * Construct a new add input generator.
	 *
	...
	public Add
		...
		super (ctor);
		if (init == null)
			throw new NullPointerException ("Add(): init is null");
		this.init = init;
		}
...
// Exported operations.
	...
	public String description()
		{
		return gen.description() + ", added to " + init;
		}
